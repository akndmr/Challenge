...
public class Shop implements Parcelable {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("name", name).append("slug", slug).append("definition", definition).append("nameUpdateable", nameUpdateable).append("vacationMode", vacationMode).append("createdAt", createdAt).append("shopPaymentId", shopPaymentId).append("productCount", productCount).append("shopRate", shopRate).append("commentCount", commentCount).append("followerCount", followerCount).append("isEditorChoice", isEditorChoice).append("isFollowing", isFollowing).append("cover", cover).append("shareUrl", shareUrl).append("logo", logo).toString();
    }
