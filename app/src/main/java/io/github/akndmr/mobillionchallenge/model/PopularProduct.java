...
public class PopularProduct implements Parcelable {
    ...
    public static final Parcelable.Creator<PopularProduct> CREATOR = new Parcelable.Creator<PopularProduct>() {
        @Override
        public PopularProduct createFromParcel(Parcel source) {
            return new PopularProduct(source);
        }
